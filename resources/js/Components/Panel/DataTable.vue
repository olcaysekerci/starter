<template>
  <div class="bg-white shadow-sm rounded-lg overflow-hidden">
    ...
    <!-- Arama ve Filtreler -->
    <div v-if="showSearch || $slots.filters" class="px-6 py-4 border-b border-gray-200 bg-gray-50">
    ...
    <!-- Sayfalama -->
    <div v-if="pagination && pagination.links" class="px-6 py-4 border-t border-gray-200">
      <Pagination
