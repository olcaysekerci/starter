        ...
        <div class="overflow-hidden">
            <div class="px-6 py-4">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <!-- Dynamic Filters -->
                    <template v-for="filter in filterConfig" :key="filter.key">
                        <div>
...
const props = defineProps({
    ...
    filterConfig: {
        type: Array,
        required: true,
        // Her filter objesi: { key, label, type, placeholder?, options? }
        // type: 'select', 'date', 'email', 'text'
    }
})
