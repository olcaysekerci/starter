    ...
    <form @submit.prevent="saveSettings" class="space-y-6">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Site Bilgileri</h3>
          <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
            Temel site bilgilerini ve görsel öğeleri yapılandırın.
          </p>
        </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">İletişim Bilgileri</h3>
          <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
            Ziyaretçilerin size ulaşabileceği iletişim bilgilerini girin.
          </p>
        </div>
        <div class="p-6 space-y-6">
          <!-- E-posta -->
