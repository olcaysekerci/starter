<template>
  ...
  >
    ...
    <FormCard
      title="Mail Ayarları"
      description="SMTP ayarları ve mail konfigürasyonunu yönetin."
      submit-text="Mail Ayarlarını Kaydet"
      :processing="saving"
      @submit="saveSettings"
    >
      <div class="space-y-8">
        <!-- Mail Durumu -->
        <div>
          <h4 class="text-md font-medium text-gray-900 dark:text-gray-100 mb-4">Mail Sistemi Durumu</h4>
        ...
        <!-- SMTP Ayarları -->
        <div>
          <h4 class="text-md font-medium text-gray-900 dark:text-gray-100 mb-4">SMTP Ayarları</h4>
          <div class="space-y-6">
            <!-- Mail Sürücüsü -->
            <div>
        ...
        <!-- Gönderen Bilgileri -->
        <div>
          <h4 class="text-md font-medium text-gray-900 dark:text-gray-100 mb-4">Gönderen Bilgileri</h4>
          <div class="space-y-6">
            <!-- Gönderen E-posta -->
            <div>
        ...
        <!-- Test Mail -->
        <div>
          <h4 class="text-md font-medium text-gray-900 dark:text-gray-100 mb-4">Mail Test</h4>
