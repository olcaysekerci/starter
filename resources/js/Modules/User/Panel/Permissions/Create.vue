      ...
      <form @submit.prevent="submitForm" class="p-6 space-y-6">
        ...
        <div>
          ...
          <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
            Yetki adı benzersiz olmalı ve küçük harflerle yazılmalıdır. Örnek: user.create, role.edit
          </p>
        </div>
        ...
        <div class="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700">
          ...
          >
            ...
            {{ form.processing ? 'Oluşturuluyor...' : 'Yetki Oluştur' }}
          </ActionButton>
        </div>
      </form>
    </div>
...
const submitForm = () => {
  form.post(route('panel.permissions.store'), {
    onSuccess: () => {
